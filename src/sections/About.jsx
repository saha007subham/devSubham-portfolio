      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          >
            ...
            >
              <div
                className="relative w-full max-w-xs rounded-3xl overflow-hidden glass-card"
                style={{
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <motion.div variants={item} className="space-y-4">
                ...
                >
                  ...
                  , contributing to scalable production-ready applications.
                </p>
              </motion.div>
            ...
            <div className="flex flex-wrap gap-2.5">
              {skills.map((skill) => (
                <motion.span
                  ...
                  className="px-4 py-2.5 rounded-xl text-xs glass-card cursor-default"
                  style={{
          ...
          <motion.div variants={item} className="grid grid-cols-3 gap-4 pt-4">
            {[
              ...
              >
                <div className="font-bold text-3xl gradient-text mb-1">
                  {stat.value}
                </div>
