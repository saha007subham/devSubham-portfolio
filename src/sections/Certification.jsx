...
const certs = [
...

  {
    ...
    description:
      "In-depth course on scalable frontend architectures and design patterns.",
...

  {
    ...
    description:
      "Deep dive into React internals, hooks, state management, and production applications.",
...

  {
    ...
    description:
      "Certification in Generative AI concepts and AI-powered applications.",
