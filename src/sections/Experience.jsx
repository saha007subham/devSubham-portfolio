...
const experiences = [
  {
    ...
    highlights: [
      ...
      "Implemented performance optimizations — 40% faster load times",

      "Integrated Generative AI / LLM features",
    ],
...

  {
    ...
    highlights: [
      ...
      "Collaborated on mobile-first design systems",
    ],
    ...
    >
      ...
      <div className="flex flex-col items-center">
        <motion.div
          ...
          className="w-12 h-12 rounded-2xl flex items-center justify-center font-bold text-sm flex-shrink-0 z-10"
          style={{
      ...
      <motion.div
        ...
        className="flex-1 p-6 rounded-2xl mb-10 glass-card"
        style={{
    ...
    <section id="experience" className="section-padding" ref={ref}>
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          >
            Professional journey building products used by thousands of users.
          </p>
        </motion.div>
