      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        <motion.div variants={container} initial="hidden" animate="show">
          ...
          <motion.div variants={item} className="mb-6">
            <span
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs tracking-widest glass-card"
              style={{
          ...
          >
            <motion.button
              ...
              className="flex items-center gap-2 px-8 py-4 rounded-full font-semibold text-sm"
              style={{
            ...
            <motion.a
              ...
              className="flex items-center gap-2 px-8 py-4 rounded-full font-semibold text-sm glass-card"
              style={{
                color: "var(--color-text)",
