...
const projects = [
  {
    ...
    description:
      "A developer-focused UI platform featuring copy-paste React components with premium modern design.",
    ...
    <section id="projects" className="section-padding" ref={ref}>
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          >
            Side projects and open-source work that showcase premium frontend
            experiences.
          </p>
        </motion.div>
